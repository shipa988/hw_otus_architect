...
// Note that using this registration option will cause many gRPC library features (such as grpc.SendHeader, etc) to stop working. Consider using RegisterNewsServiceHandlerFromEndpoint instead.
...
var (
	pattern_NewsService_GetNews_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"news", "userid"}, "", runtime.AssumeColonVerbOpt(true)))
)
